...
export const SPARK_SELECT_FIELDS =
  'ListingKey,ListingId,StandardStatus,MlsStatus,ListPrice,ClosePrice,BedsTotal,BathsFull,BathsHalf,BathroomsTotalInteger,LivingArea,LotSizeAcres,LotSizeSquareFeet,YearBuilt,SubdivisionName,PublicRemarks,UnparsedAddress,City,StateOrProvince,PostalCode,StreetNumber,StreetName,StreetSuffix,Latitude,Longitude,ModificationTimestamp,StatusChangeTimestamp,PriceChangeTimestamp,ListingContractDate,OnMarketDate,CloseDate,ListAgentName,ListAgentMlsId,ListAgentStateLicense,ListAgentEmail,ListOfficeName,ListOfficeMlsId,PhotosCount,VirtualTourURLUnbranded,VOWAutomatedValuationDisplayYN,ElementarySchool,MiddleOrJuniorSchool,HighSchool,PropertyType,PropertySubType,Levels,GarageSpaces,NewConstructionYN,SeniorCommunityYN,AssociationYN,AssociationFee,AssociationFeeFrequency,TaxAmount,View,WaterFrontYN,WaterSource,Sewer,FireplaceYN,FireplaceFeatures,PoolFeatures'
