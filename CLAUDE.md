...
| **Asset library — register, query, or reuse media assets** | `video_production_skills/asset-library/SKILL.md` (manifest at `data/asset-library/manifest.json`, CLI at `lib/asset-library.mjs`) |
