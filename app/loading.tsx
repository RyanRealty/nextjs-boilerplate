  ...
  return (
    <main className="min-h-screen bg-[var(--background)]">
      ...
      <div className="relative flex min-h-[520px] items-center justify-center bg-primary">
        <div className="h-12 w-3/4 max-w-md animate-pulse rounded bg-white/20" />
      </div>
      ...
      <section className="bg-white px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-6 flex gap-4 overflow-hidden">
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-[340px] min-w-[280px] animate-pulse rounded-lg bg-[var(--muted)]" />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="bg-muted px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-6 flex gap-4 overflow-hidden">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-[340px] min-w-[280px] animate-pulse rounded-lg bg-white/80" />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="bg-primary px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto h-8 w-72 animate-pulse rounded bg-white/20" />
      ...
      <section className="bg-muted px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-6 flex gap-4">
            <div className="h-12 flex-1 animate-pulse rounded-lg bg-white/80" />
            <div className="h-12 w-28 animate-pulse rounded-lg bg-[var(--muted)]" />
          </div>
        </div>
      </section>
    </main>
