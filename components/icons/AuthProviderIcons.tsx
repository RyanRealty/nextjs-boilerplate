...
/** Google "G" logo — single-color for theme compliance (currentColor). */
...
/** Apple logo — single-color for theme compliance (currentColor). */
...
/** Facebook "f" logo — single-color for theme compliance (currentColor). */
