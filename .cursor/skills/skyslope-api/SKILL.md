...
When reviewing **whether a file satisfies Oregon regulatory expectations** (supervision, records, agency, trust themes), combine this skill with **`oregon-orea-principal-broker`** for an **educated first pass** on OREA / OAR 863—you still sign off as principal broker.
